<fieldset class="grid grid-cols-4 gap-6 p-6 rounded-md shadow-sm bg-gray-100">
    ...
    <div class="grid grid-cols-4 gap-4 col-span-full lg:col-span-3">
        ...
        <x-form.formMessage color="red" state="oops" message="There are some errors with your submission." />
        @endif
        {{-- success message --}}
        @if ($success)
        ...
        <x-form.input label="كلمة المرور" name="confirmPassword" type="password" />
        {{-- trainer type --}}
        <div class="flex py-3 ">
