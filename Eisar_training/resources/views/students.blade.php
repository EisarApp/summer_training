...
<body class="antialiased font-sans">
    <div class="container mx-auto px-4 py-3 sm:px-8">
        <div class="py-8">
            <div class="flex sm:flex-row flex-col gap-4 items-center float-left bg-white">
    ...
    <div class="container mx-auto px-4 sm:px-8">
        <div class="py-8 ">
            ...
            <div class="flex sm:flex-row flex-col gap-4 items-center bg-white">
                {{-- search input --}}
                ...
                <div class="block relative">
                    <button type="button"
                        class="block pl-8 pr-6 py-2 bg-white border border-gray-400 text-gray-700 font-medium text-xs leading-normal uppercase rounded  hover:bg-gary-400  focus:bg-gary-400  focus:outline-none focus:ring-0   transition duration-150 ease-in-out flex align-center">
