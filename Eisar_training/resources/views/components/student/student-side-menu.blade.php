<div>
    ...
    <div class="col-span-1">
        ...
        <div class="sidebar  top-0 bottom-0 lg:right-0 right-[0px] duration-1000
            p-2 w-[260px] overflow-y-auto text-center bg-gray-100 shadow h-screen ">
            <div class="text-gray-500 text-xl">
                ...
                <div>
                    ...
                    <div class="hover:bg-gradient-to-r from-blue-200 to-blue-900  px-4 duration-300">
                        ...
                        <div
                            class="p-2.5 mt-2 flex items-center cursor-pointer   hover:text-white dark:hover:text-white ">
                            <iconify-icon icon="eva:person-done-outline" width="26" height="26"></iconify-icon>
                            <span
                    ...
                    <div class="hover:bg-gradient-to-r from-blue-200 to-blue-900  px-4 duration-300">
                        ...
                        <div
                            ...
                            <span class="text-[15px] mr-4 text-base text-gray group-hover:text-white ml-auto text-sm">
                                الاعدادات</span>
